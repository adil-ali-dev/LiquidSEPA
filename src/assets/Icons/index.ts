...
export { ReactComponent as StatusSuccessIcon } from './status-success.svg';
export { ReactComponent as StatusErrorIcon } from './status-error.svg';
export { ReactComponent as StatusWarningIcon } from './status-warning.svg';
export { ReactComponent as StatusWaitingIcon } from './status-waiting.svg';
